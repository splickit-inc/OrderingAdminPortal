...
<table width="100%" cellspacing="0" cellpadding="0" border="0"
       style="margin:0 auto; width: 100%;background: #ffffff;max-width: 600px; font-family: 'Roboto', 'Open Sans', sans-serif;font-size: 14px;">
    <tr>
        <td>
                ...
                <tr>
                    <td width="600">
                        ...
                        <div style="text-align: center;">
                            <a href="{!! $url.'/#/customer/'.$lead['guid'].'/setup' !!}">
                                <img src="https://s3.amazonaws.com/com.yourbiz.products/admin_portal/merchant_form_2/img/email/button-1.png"
                                     alt="button">
                            </a>
