    ...
    <div class="panel panel-color panel-primary panel-pages">
        <div class="panel-body" ng-controller="ResetPasswordController">
            ...
            <form class="form-horizontal m-t-20" name="login_form" novalidate ng-submit="sendEmail()">
                ...
                <div ng-show="password_reset_sent" class="col-md-12 m-t-15">
                    <div class="alert alert-success alert-reg-position form-submit-success fade-effect"
                         role="alert">
                        <i class="fa fa-info-circle" aria-hidden="true"></i> A link to reset your password has been sent to your email address.
                    </div>
                </div>

                <div class="form-group m-t-30 m-b-0">
                    <div class="col-sm-7">
                        <a href="/" class="text-muted"><i class="fa fa-lock m-r-5"></i> Back To Login</a>
                    </div>
                </div>
