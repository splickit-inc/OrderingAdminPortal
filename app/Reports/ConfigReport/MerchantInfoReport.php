...
class MerchantInfoReport extends BaseReport {
    ...
    public function setSelect() {
        $this->query = $this->query->select('Merchant.merchant_id', 'Merchant.display_name',
            ...
            DB::raw("if(Merchant.group_ordering_on='1','On','Off') as group_ordering_on"),
