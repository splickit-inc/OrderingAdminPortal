(function () {
    ...
    /* globals $: false */
    angular.module('adminPortal.reports').component('menuExportComponent', {
        templateUrl: 'modules/reports/components/menu-export-component/menu-export-component.html',
        controllerAs: 'vm',
        bindings: {
            processing: '=?',
            exporting: '=?',
        ...
        controller: menuExportComponentController
    });

    function menuExportComponentController(Reports, MerchantConfigService, ReportsGroupBySelections, UtilityService) {
        var vm = this;
