...
describe('Merchant Ordering', function() {
    it('Should Be Able to Update Merchant Ordering', function() {

        browser.get('/#/merchant/ordering');
        ...
        //ValidatorHelpers.elementContainsTextById('delivery-increments-success', 'Delivery Fees Updated');
        ...
        var create_dz_type_select = element(by.name('delivery_type'));
