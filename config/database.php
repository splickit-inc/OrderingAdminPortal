...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            'driver' => 'mysql',
            'host' => env('SMAW_DB_HOST', '127.0.0.1'),
            'port' => env('SMAW_DB_PORT', '3306'),
            'database' => env('SMAW_DB_DATABASE', 'forge'),
            'username' => env('SMAW_DB_USERNAME', 'forge'),
            'password' => env('SMAW_DB_PASSWORD', ''),
            'charset' => 'utf8mb4',
